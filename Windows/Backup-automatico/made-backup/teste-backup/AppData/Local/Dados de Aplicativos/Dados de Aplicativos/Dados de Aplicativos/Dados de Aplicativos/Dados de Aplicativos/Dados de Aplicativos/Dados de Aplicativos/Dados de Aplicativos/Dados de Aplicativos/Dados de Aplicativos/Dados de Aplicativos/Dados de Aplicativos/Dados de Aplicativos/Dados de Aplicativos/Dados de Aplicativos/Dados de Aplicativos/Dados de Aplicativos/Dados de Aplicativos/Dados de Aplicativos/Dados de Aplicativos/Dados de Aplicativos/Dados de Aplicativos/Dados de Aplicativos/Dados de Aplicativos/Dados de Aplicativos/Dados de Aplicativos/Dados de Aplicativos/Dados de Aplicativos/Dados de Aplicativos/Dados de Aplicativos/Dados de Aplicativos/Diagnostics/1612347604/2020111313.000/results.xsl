...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:ms="urn:microsoft-performance" exclude-result-prefixes="msxsl" version="1.0">
	...
	<xsl:variable name="images">
		...
		<!-- root cause states -->
		<String id="fixed">Corrigido</String>
		<String id="notfixed">Não Corrigido</String>
		<String id="detected">Detectado</String>
		<!-- details -->
		<String id="info">Informativo</String>
		<String id="warning">Aviso</String>
		<String id="error">Erro</String>
		<!-- expand and print buttons -->
		<String id="expand">Expandir</String>
...
function key_folder(d, state)
{
  if (window.event.keyCode == 13) {
    ...
    event.returnValue = false;
						...
						<div class="page">
							<xsl:variable name="strings">
								<String id="Found">Problemas detectados</String>
								<String id="Checked">Possíveis problemas verificados</String>
								<String id="Publisher">Detalhes do fornecedor</String>
								<String id="Detection">Detalhes de detecção</String>
	...
	<xsl:template name="RootCauseStatus">
		<xsl:variable name="strings">
			<String id="Fixed">Corrigido</String>
			<String id="Not Detected">Problema ausente</String>
			<String id="Not Fixed">Não corrigido</String>
			<String id="Detected">Detectado</String>
		</xsl:variable>
		<div>
			<xsl:if test="Data[@id='Status'] = 'Not Detected'">
	...
	<xsl:template name="RootCauseEmpty">
		<xsl:variable name="strings">
			<String id="Empty">Não foram detectados problemas</String>
		</xsl:variable>
	...
	<xsl:template name="ResolutionStatus">
		<xsl:variable name="strings">
			<String id="Not Run">Não executado</String>
			<String id="Succeeded">Concluído</String>
			<String id="Failed">Falhou</String>
			<String id="Informational">Informativo</String>
	...
	<xsl:template name="ScriptStatus">
		<xsl:variable name="strings">
			<String id="Succeeded">Com êxito</String>
			<String id="Failed">Falha</String>
		</xsl:variable>
		<xsl:choose>
	...
	<xsl:template match="InputArguments[Data]|OutputArguments[Data[@id !='Result']]">
		<xsl:variable name="strings">
			<String id="InputArguments">Argumentos de Entrada</String>
			<String id="OutputArguments">Argumentos de Saída</String>
		</xsl:variable>
	...
	<xsl:template match="Object[@Type='System.Diagnostics.Eventing.Reader.EventLogRecord']">
		<xsl:variable name="strings">
			<String id="LevelDisplayName">Nível</String>
			<String id="LogName">Log</String>
			<String id="TimeCreated">Data</String>
	...
	<xsl:template match="ComputerInformation">
		<xsl:variable name="strings">
			<String id="Computer">Nome do computador</String>
			<String id="Collection">Informações sobre coleção</String>
		</xsl:variable>
