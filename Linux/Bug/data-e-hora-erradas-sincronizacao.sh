...
echo
echo "		| -- Atualizando o sistema e pacotes -- |"
echo

if ! sudo apt update && sudo apt upgrade
then
	echo "-- Verifique os pacotes, erro na atualização do sistema no update/upgrade --"
exit 1
fi
...
then
	echo "-- Problema ao atualizar o kernel do sistema, verifique! --"
exit 1
fi
